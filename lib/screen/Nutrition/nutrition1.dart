...
class Nutrition1 extends StatefulWidget {
  final String cole;

  Nutrition1(this.cole);

  @override
  _Nutrition1State createState() => _Nutrition1State();
}

class _Nutrition1State extends State<Nutrition1> {
  bool isClick = false;
  void init() {
    super.initState();
    setState(() {
      ...
      body: Stack(
        children: [
          SingleChildScrollView(
            child: Column(
              children: [
                Image.asset('assets/nutrition/nu1.jpeg'),
                Row(
                  ...
                  children: [
                    ...
                    Text('피지오겔 RED SOOTHING AI Cream',
                        style: TextStyle(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () {
                          setState(() {
                            isClick = true;
                            print(Get.find<SimpleController>().getCounter(1));
                            Get.find<SimpleController>().saveCounter(1);
                            print(Get.find<SimpleController>().getCounter(1));
                          });
                        },
