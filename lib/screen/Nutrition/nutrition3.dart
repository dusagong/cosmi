...
class Nutrition3 extends StatefulWidget {
  final String cole;

  Nutrition3(this.cole);

  @override
  _Nutrition3State createState() => _Nutrition3State();
}

class _Nutrition3State extends State<Nutrition3> {
  bool isClick = false;
  void init() {
    super.initState();
    setState(() {
      ...
      body: Stack(
        children: [
          SingleChildScrollView(
            child: Column(
              children: [
                Image.asset('assets/nutrition/nu3.jpeg'),
                Row(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () {
                          setState(() {
                            isClick = true;
                            Get.find<SimpleController>().saveCounter(3);
                          });
                        },
