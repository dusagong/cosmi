...
class Analysis3 extends StatefulWidget {
  const Analysis3({Key? key}) : super(key: key);

  @override
  State<Analysis3> createState() => _Analysis3State();
}

class _Analysis3State extends State<Analysis3> {
  @override
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 122,
                        height: 122,
                        child: Image.asset('assets/nutrition/nu3.jpeg',),
                        decoration: BoxDecoration(
